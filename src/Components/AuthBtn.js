...
const AuthBtn = () => {
  ...
  return (
    <div className="flex">
      <button onClick={() => setIsOpen(true)} className="py-2 px-3 text-[#B2B2B2] hover:text-lg hover:text-black hover:font-bold duration-200">
        Log in
      </button>
      <Transition show={isOpen} enter="transition" enterFrom="opacity-0 duration-300" enterTo="opacity-100 duration-300" leave="transition" leaveFrom="opacity-100 duration-300" leaveTo="opacity-0 duration-300" as={Fragment}>
        <Dialog as="div" open={isOpen} onClose={() => setIsOpen(false)} className="fixed inset-0 flex items-center justify-center">
          ...
          <Dialog.Panel className="min-w-[80%] max-w-[80%] md:min-w-[45%] md:max-w-[45%] max-h-[100%] p-14 rounded bg-yellow-50 shadow-lg z-10">
            {/* Tab start */}
            <Tab.Group>
              <Tab.List className="space-x-1 flex justify-center py-1 px-1 rounded-xl bg-black/40">
                <div>
              ...
              <Tab.Panels>
                <Tab.Panel className="w-full rounded-xl mt-2 flex justify-center">
                  <form method="post" className="bg-white shadow-lg p-5 rounded-xl min-w-full">
                    ...
                    <input type="text" id="email" for="email" className="w-full px-2 py-1 rounded ring-2 ring-yellow-500"></input>
                    <br />
                    <label id="password">Password :</label>
                    <input type="password" id="password" for="password" className="w-full px-2 py-1 rounded ring-2 ring-yellow-500"></input>
                ...
                <Tab.Panel className="w-full rounded-xl mt-2 flex justify-center">
                  <form method="post" className="bg-white shadow-lg p-5 rounded-xl min-w-full">
                    ...
                    <input type="text" id="name" for="name" className="w-full px-2 py-1 rounded ring-2 ring-yellow-500"></input>
                    <br />
                    <label id="email">Email :</label>
                    <input type="text" id="email" for="email" className="w-full px-2 py-1 rounded ring-2 ring-yellow-500"></input>
                    <br />
                    ...
                    <input type="password" id="cnfpassword" for="cnfpassword" className="w-full px-2 py-1 rounded ring-2 ring-yellow-500"></input>
                    <br />
                    <br />
                    <button onClick={() => setIsOpen(false)} className="bg-red-200 text-red-400 font-semibold py-2 px-3 rounded mr-1 hover:bg-red-100 duration-100">
                      Close
